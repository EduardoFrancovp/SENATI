          ...
          <div class="x_content">
            ...
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              <div class="form-group">
                <label class="control-label col-md-4 col-sm-12 col-xs-4">Nombre Objetivo<span class="required">*</span>
                </label>
			...
			<table class="table table-striped jambo_table bulk_action">
		        ...
		        <tbody>
		          <tr class="odd pointer">
		            ...
		            <td class="a-right a-right">Realizar semana tecnologia ETI</td>
